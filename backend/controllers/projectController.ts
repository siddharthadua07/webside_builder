...
Return ONLY the enhanced request, nothing else. Keep it concise (1-2 sentences).`
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: `I have enhanced your prompt tp  : "${enhancedPrompt}"`,
                projectId
            }
        })
    ...
    Apply the requested changes while maintaining the Tailwind CSS styling approach.`
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: "I have made the changes to your webside! You can now preview it",
                projectId
            }
        })
...
// Controllers Function to rollback to a specific version 
...
//Controller Function for delete a project
